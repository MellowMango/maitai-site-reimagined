            ...
            <Tabs.List className="inline-flex items-center justify-center rounded-full bg-gray-100 p-1">
                {tabs.map((tab) => (
                    <Tabs.Trigger
                        ...
                        value={tab.value}
                        className={cn(
                            'inline-flex items-center justify-center whitespace-nowrap rounded-full px-6 py-2 text-base font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
